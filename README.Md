...
```
 ...
 `features/`: This folder will contains the feature files for the feature that is being tested. The feature files define the behavior and requirements for a specific feature.
